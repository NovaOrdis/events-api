...
public interface OSMetricDefinition extends MetricDefinition {
    ...
    /**
     * @return the command to be executed to obtain the metric value, on Linux.
     */
    String getLinuxCommand();

    /**
     * @return the command to be executed to obtain the metric value, on Mac.
     */
    String getMacCommand();

    /**
     * @return the command to be executed to obtain the metric value, on Windows.
     */
     ...
     * the method must return a valid Property instance containing a null value. No exception must be thrown in this
     * case. The implementation should also log as WARN more details on why collection failed.
     */
