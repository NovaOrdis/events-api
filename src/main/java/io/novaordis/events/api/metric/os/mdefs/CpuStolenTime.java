 ...
 *
 * https://kb.novaordis.com/index.php/Events_OS_Metrics#CpuStolenTime
 *
...
public class CpuStolenTime extends OSMetricDefinitionBase {
    ...
    protected InternalMetricReadingContainer parseSourceFileContent
        ...
        if (OSType.LINUX.equals(osType)) {
            ...
            float value = ((CPUStats) preParsedContent[1]).getStealTimePercentage((CPUStats) preParsedContent[2]);
