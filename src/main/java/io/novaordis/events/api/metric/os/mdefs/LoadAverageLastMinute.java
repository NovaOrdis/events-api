...
/**
 * https://kb.novaordis.com/index.php/Events_OS_Metrics#LoadAverageLastMinute
 *
...
public class LoadAverageLastMinute extends OSMetricDefinitionBase {
    ...
    public LoadAverageLastMinute(PropertyFactory propertyFactory, OSAddress osAddress) {
