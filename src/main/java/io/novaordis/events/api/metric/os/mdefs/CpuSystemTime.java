 ...
 *
 * https://kb.novaordis.com/index.php/Events_OS_Metrics#CpuSystemTime
 *
 * @author Ovidiu Feodorov <ovidiu@novaordis.com>
 * @since 8/3/16
 */
public class CpuSystemTime extends OSMetricDefinitionBase {
    ...
    public CpuSystemTime(PropertyFactory propertyFactory, OSAddress osAddress) {

        super(propertyFactory, osAddress);

        this.TYPE = Float.class;

        this.LABEL = "CPU System Time";
    ...
    protected InternalMetricReadingContainer parseSourceFileContent(
        ...
        if (OSType.LINUX.equals(osType)) {
            ...
            float value = ((CPUStats) pp.getCurrent()).getSystemTimePercentage((CPUStats) pp.getPrevious());
